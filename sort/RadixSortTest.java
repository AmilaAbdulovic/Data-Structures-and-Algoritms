...
class RadixSortTest extends AbstractSortTest {
	...
	void testMeasurePerformance() {
		runAndMeasureAlgorithm("radix", 100);
		runAndMeasureAlgorithm("radix", 1000);
		runAndMeasureAlgorithm("radix", 10000);
		runAndMeasureAlgorithm("radix", 100000);
		runAndMeasureAlgorithm("radix", 1000000);
	}
}
