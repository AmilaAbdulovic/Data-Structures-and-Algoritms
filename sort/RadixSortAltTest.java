...
class RadixSortAltTest extends AbstractSortTest {
	...
	void testMeasurePerformance() {
		runAndMeasureAlgorithm("radix-alt", 100);
		runAndMeasureAlgorithm("radix-alt", 1000);
		runAndMeasureAlgorithm("radix-alt", 10000);
		runAndMeasureAlgorithm("radix-alt", 100000);
		runAndMeasureAlgorithm("radix-alt", 1000000);
	}
}
