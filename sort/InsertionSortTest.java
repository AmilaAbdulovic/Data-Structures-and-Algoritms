...
class InsertionSortTest extends AbstractSortTest {
	...
	void testMeasurePerformance() {
		runAndMeasureAlgorithm("insertion", 100);
		runAndMeasureAlgorithm("insertion", 1000);
		runAndMeasureAlgorithm("insertion", 10000);
		runAndMeasureAlgorithm("insertion", 100000);
//		runAndMeasureAlgorithm("selection", 1000000);
	}
}
