...
class BottomUpMergeSortTest extends AbstractSortTest {
	...
	void testMeasurePerformance() {
		runAndMeasureAlgorithm("iterative-merge", 100);
		runAndMeasureAlgorithm("iterative-merge", 1000);
		runAndMeasureAlgorithm("iterative-merge", 10000);
		runAndMeasureAlgorithm("iterative-merge", 100000);
		runAndMeasureAlgorithm("iterative-merge", 1000000);
	}
}
