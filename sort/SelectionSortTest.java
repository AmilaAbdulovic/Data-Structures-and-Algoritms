...
class SelectionSortTest extends AbstractSortTest {
	...
	void testMeasurePerformance() {
		runAndMeasureAlgorithm("selection", 100);
		runAndMeasureAlgorithm("selection", 1000);
		runAndMeasureAlgorithm("selection", 10000);
		runAndMeasureAlgorithm("selection", 100000);
